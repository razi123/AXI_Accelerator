...
HD_PWD='C:/Users/khazi/projects/AXI_Multiply/AXI_Multiply.runs/design_1_multiply_2bit_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_multiply_2bit_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_multiply_2bit_0_0.tcl
